...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.statistic_2.setStyleSheet("color:blue")
        font = QtGui.QFont()
        ...
        self.statistic_2.setStyleSheet("background:transparent;color:blue")
        ...
        font = QtGui.QFont()
        font.setFamily("KaiTi")##KaiTiAgency FB
        ...
        font = QtGui.QFont()
        font.setFamily("KaiTi")##Agency FB
        font.setPointSize(14)
        ...
        self.statistic.setAutoFillBackground(True)
        self.statistic.setStyleSheet("background:transparent;color:blue")
        ...
        ##设置多路摄像头接入
        self.setWebCam = QtWidgets.QAction(MainWindow)

        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("./icon/cam.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.setWebCam.setIcon(icon5)
        self.cam_switch.setObjectName("设置双摄像头")

        ##触发网络摄象头检测
        self.detectDouble=QtWidgets.QAction(MainWindow)
        self.detectDouble.setCheckable(True)
        self.detectDouble.setChecked(False)
        self.detectDouble.setEnabled(True)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("./icon/trigger.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.detectDouble.setIcon(icon6)
        self.detectDouble.setObjectName("网络摄像头检测")
        ...
        self.toolBar.addAction(self.setWebCam)
        self.toolBar.addAction(self.detectDouble)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.setWebCam.setText(_translate("MainWindow", "设置双摄像头"))
        self.setWebCam.setToolTip(_translate("MainWindow", "设置双摄像头"))

        self.detectDouble.setText(_translate("MainWindow", "DETECT"))
        self.detectDouble.setToolTip(_translate("MainWindow", "DETECT"))
